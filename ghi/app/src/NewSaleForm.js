                    ...
                    <div className="shadow p-4 mt-4">
                        ...
                        <form onSubmit={this.handleSubmit} id="create-NewSale-form">
                            <div className="form-floating mb-3">
                                <select onChange={this.handleChange} required name="auto" id="auto" className="form-select">
                            ...
                            <div className="form-floating mb-3">
                                <input value={this.state.salesPrice} onChange={this.handleChange} placeholder="sales_price" required type="text" name="sales_price" id="sales_price" className="form-control" />
